    ...
    <div className='session-container'>
      <div className='session-form-container'>
        ...
        <form className="session-form">
          <input type='email' placeholder='Email' className='session-input'></input>
          <input type='password' placeholder='Create a password' className='session-input'></input>
          <input type='number' placeholder='Age' className='session-input'></input>
          <button type='submit' className='session-continue-btn'>Continue</button>
        </form>
        <p className='or'>Or</p>
